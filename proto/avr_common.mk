...
app append: $(NAME).hex
	# append bootloader hex code to this hex file but remove :00000001FF (intel hex eof) from main.hex first
	sed -i '$$d' $(NAME).hex
	cat bootloader/atmega169/bootloader-*.hex >> $(NAME).hex
